# Documentation Specialist Agent Invocation

Read the agent definition from `.claude/agents/documentation-specialist.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/documentation-specialist.md`
...
Pass the user's request to the Documentation Specialist agent now.