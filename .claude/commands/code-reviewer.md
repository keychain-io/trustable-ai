# Code Reviewer Agent Invocation

Read the agent definition from `.claude/agents/code-reviewer.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/code-reviewer.md`
...
Pass the user's request to the Code Reviewer agent now.