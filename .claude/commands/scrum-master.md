# Scrum Master Agent Invocation

Read the agent definition from `.claude/agents/scrum-master.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/scrum-master.md`
...
Pass the user's request to the Scrum Master agent now.