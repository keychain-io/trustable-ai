# Release Manager Agent Invocation

Read the agent definition from `.claude/agents/release-manager.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/release-manager.md`
...
Pass the user's request to the Release Manager agent now.