# Technical Writer Agent Invocation

Read the agent definition from `.claude/agents/technical-writer.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/technical-writer.md`
...
Pass the user's request to the Technical Writer agent now.