...
1. **Query all sprint work items:**
   ...
   az boards query --wiql "SELECT [System.Id], [System.Title], [System.State], [System.AssignedTo], [Microsoft.VSTS.Scheduling.StoryPoints], [System.ChangedDate] FROM WorkItems WHERE [System.TeamProject] = 'Trusted AI Development Workbench' AND [System.IterationPath] = 'Trusted AI Development Workbench\\SPRINT_NAME'" --output json
   ```
...
3. **Categorize work items:**
   ...
   - ⏭️ **Carry Over**: Active items moving to next sprint
   - ❌ **Removed**: Items removed from sprint
   - 🐛 **Bugs**: Bugs found and fixed in sprint
   - 📊 **Technical Debt**: Debt added vs. paid down
...
3. **Analyze incomplete work:**
   ...
   - **Spawn agent** using Task tool with model `claude-sonnet-4.5`
...
```markdown
# Sprint Completion Report - Trusted AI Development Workbench
...
### Work Breakdown
- ✅ Completed: [X] items ([Y] SP)
- ⏭️ Carried Over: [X] items ([Y] SP)
- ❌ Removed: [X] items ([Y] SP)
- 🐛 Bugs Fixed: [X] items
...
- **Test Coverage**: [X]% (target: 80%)
  - Change: [↑/↓ X%] from last sprint
- **Critical Vulnerabilities**: [X] (max: 0)
- **High Vulnerabilities**: [X] (max: 0)
- **Code Complexity**: [Avg X] (max: 10)
- **Bugs Created**: [X]
- **Bugs Fixed**: [Y]
...
- [Link to Sprint Board](https://dev.azure.com/keychainio//Trusted AI Development Workbench)
...
2. **Create next sprint structure:**
   ...
   az boards iteration project create \
     --name "Sprint NEXT_SPRINT_NUMBER" \
     --project "Trusted AI Development Workbench" \
     --path "Trusted AI Development Workbench"
   ```
...
- ✅ All work items in final state (Done/Carried Over/Removed)
- ✅ Incomplete work properly documented and moved
- ✅ Sprint metrics calculated and recorded
- ✅ Completion report generated and distributed
- ✅ Sprint data archived for historical analysis
- ✅ Next sprint prepared with recommended capacity
- ✅ Stakeholders notified of sprint results
- ✅ Roadmap and planning artifacts updated
...
**Agents Used:**
- Scrum Master (incomplete work analysis, recommendations)
