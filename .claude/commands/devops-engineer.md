# Devops Engineer Agent Invocation

Read the agent definition from `.claude/agents/devops-engineer.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/devops-engineer.md`
...
Pass the user's request to the Devops Engineer agent now.