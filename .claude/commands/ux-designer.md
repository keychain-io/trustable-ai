# Ux Designer Agent Invocation

Read the agent definition from `.claude/agents/ux-designer.md` and invoke it as a separate agent using the Task tool.
...
1. Read the full agent definition from `.claude/agents/ux-designer.md`
...
Pass the user's request to the Ux Designer agent now.