---
context:
  keywords: [agent, template, registry, render, analyst, architect, engineer, scrum, qa, devops, security]
  task_types: [sprint-planning, sprint-execution, backlog-grooming, implementation]
  priority: high
  max_tokens: 800
  children:
    - path: agents/templates/CLAUDE.md
      when: [template, jinja, customize]
  dependencies: []
---
# agents
